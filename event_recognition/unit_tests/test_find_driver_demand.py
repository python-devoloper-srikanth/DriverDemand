...
class TestDriverDemand(unittest.TestCase):
    ...
    def test_find_driver_demand_sample(self):
        # get the data from json as dictionary
        # Navigate to the i/o file - 'get_driver_demand.json'
        file_path = os.path.join(get_input_data_directory_path(), 'get_driver_demand_sample.json')
        json_data_dict = read_json(file_path)
    ...
    def test_find_driver_demand_sample2(self):
        # get the data from json as dictionary
        # Navigate to the i/o file - 'get_driver_demand.json'
        file_path = os.path.join(get_input_data_directory_path(), 'get_driver_demand_sample_2.json')
        json_data_dict = read_json(file_path)
